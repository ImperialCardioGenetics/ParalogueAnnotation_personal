...
KCNH2_data = KCNH2_data[!is.na(KCNH2_data$exacAlleleCount),]
...
KCNQ1_data = KCNQ1_data[!is.na(KCNQ1_data$exacAlleleCount),]
...
SCN5A_data = SCN5A_data[!is.na(SCN5A_data$exacAlleleCount),]
```
