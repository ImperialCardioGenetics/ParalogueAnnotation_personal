...
p.var_in_genes_unique_var = p.var_in_genes_unique_var[p.var_in_genes_unique_var$Var1 %in% clinvar_P_LP_tableized_genes,] #802 HERE!!!
...
dim(clinvar_P_LP_tableized[!is.na(clinvar_P_LP_tableized$Amino_acids) & !(grepl("-", clinvar_P_LP_tableized$Amino_acids)) & !(grepl("-", clinvar_P_LP_tableized$Protein_position)) & !(grepl("\\*", clinvar_P_LP_tableized$Amino)) & grepl("/", clinvar_P_LP_tableized$Amino_acids) & str_count(clinvar_P_LP_tableized$Amino_acids) == 3,])
