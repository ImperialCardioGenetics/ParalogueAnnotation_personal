...
Cannot QC for alt allele when using "paraloc" mode as it does not return alt allele. E.g. look at variant ID 13034 in p.tableized_data - REFID=1 for AA but neither ref allele nor alt allele for nt match.
...
#### Plan for quality control of annotations
