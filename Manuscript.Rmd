...
bar_chart = ggplot(df, aes(y=reclassified_vus,x=bar,fill=Type)) + geom_bar(stat="identity",position = "identity",width = 0.3) +
...
ggsave("images/reclassified_vus_clinvar_set_bar_chart.png", height = 14, width = 12)
```
