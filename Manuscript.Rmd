...
#QC1 patho
p.normal_PA = Paralogous_var_align("data/all_possible_mutations/SCN5A/synthetic.vep.cov.table_chrom2_onlySCN5A_variants.out_paraloc_paralogs2.para_con", "data/all_possible_mutations/SCN5A/synthetic.vep.cov.table_chrom2_onlySCN5A_variants.out_paraloc_tableized", "data/clinvar/clinvar_20190520_GRCh37_onlyPathogenic_and_Likely_pathogenic.out_paraloc_tableized")
clinvar_P_LP_tableized = read.csv(file="data/clinvar/clinvar_20190520_GRCh37_onlyPathogenic_and_Likely_pathogenic.out_paraloc_tableized", sep = "\t", header=TRUE, stringsAsFactors=FALSE)
clinvar_P_LP_tableized = clinvar_P_LP_tableized[clinvar_P_LP_tableized$SYMBOL == "SCN5A",]
clinvar_P_LP_tableized_protein_pos = as.numeric(unique(clinvar_P_LP_tableized[!is.na(clinvar_P_LP_tableized$Protein_position) & !(grepl("-", clinvar_P_LP_tableized$Protein_position)),"Protein_position"]))
patho_protein_pos = unique(p.normal_PA$Total_paralog_annotations[!is.na(p.normal_PA$Total_paralog_annotations$ID.y),"Protein_position.x"])
