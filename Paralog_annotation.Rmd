...
* For the number of variants being patho or benign, how many of them actually align to anther variant? At least ones within paralogues? Difference between patho and benign variants?
...
```{r paralog_dist, echo = FALSE, warning=FALSE, fig.cap = cap}
...
In total, `r conf$con_table[1]` Pathogenic and Likely Pathogenic variants and `r conf$con_table[2]` Benign and Likey Benign variants were from clinvar. 
