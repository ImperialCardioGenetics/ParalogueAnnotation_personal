...
protein_classes2$stage = "para_genes"
...
protein_classes3$stage = "mis_clinvar"
#Total_plot
...
gg_protein_class = ggplot(total_protein_class, aes(y=number_of_genes, x=reorder(Protein_class, number_of_genes), fill = factor(stage, levels=c("noQC","para_genes","mis_clinvar")))) +
