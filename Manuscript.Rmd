...
NDD_notin_discovEHR = dplyr::select(NDD_notin_discovEHR, c(dnv,DNV_pub,MPC,segregation,class,comp,PUBMED))
tmp_df = ddply(NDD_notin_discovEHR,.(Location,Allele),nrow)
...
rare_pa_controls_affected = dim(var_pred_patho)[1]
