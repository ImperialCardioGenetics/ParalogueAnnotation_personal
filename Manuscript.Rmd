...
cols = c("no_dis_no_para" = "red", "yes_dis_no_para" = "purple", "no_dis_yes_para" = "green", "Yes_dis_Yes_para" = "gold")
dens = ggplot(total_plot_data, aes(x=number_of_paralogues)) + 
  geom_histogram(data = total_plot_data[total_plot_data$disease=="No" & total_plot_data$paralogue == "No",], aes(fill = "no_dis_no_para"), alpha = 0.8, binwidth = 1) +
  geom_histogram(data = total_plot_data[total_plot_data$disease=="Yes" & total_plot_data$paralogue == "No",], aes(fill = "yes_dis_no_para"), alpha = 0.8, binwidth = 1) +
  geom_histogram(data = total_plot_data[total_plot_data$disease=="No" & total_plot_data$paralogue == "Yes",], aes(fill = "no_dis_yes_para"), alpha = 0.8, binwidth = 1) +
  geom_histogram(data = total_plot_data[total_plot_data$disease=="Yes" & total_plot_data$paralogue == "Yes",], aes(fill = "Yes_dis_Yes_para"), alpha = 0.8, binwidth = 1) +
  scale_fill_manual(values = cols, labels = c("Non-disease gene, no paralogues", "Non-disease gene, has paralogues", "Disease gene, no paralogues",  "Disease gene, has paralogues")) +
