...
The Total case counts for gnomad would be the mean of all allele numbers of respective variants being considered divided by 2 (due to homo/heterozygous).
...
KCNQ1_data_ref = read.csv("data/OMGL_LQTS/KCNQ1_JamesWare_270117.csv", sep = ",")
...
KCNH2_data_ref = read.csv("data/OMGL_LQTS/KCNH2_JamesWare_270117.csv", sep = ",") 
...
SCN5A_data_ref = read.csv("data/OMGL_LQTS/SCN5A_JamesWare_270117.csv", sep = ",")
...
write.table(vcf_Total_var, file = "data/OMGL_LQTS/All_variants.vcf", sep = "\t", quote = FALSE, row.names = FALSE)
```
...
gg = ggplot(other_tools_data, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=4) + 
  ...
  xlim(0,1) + ylim(0.75,1)  + theme(plot.subtitle = element_text(vjust = 1),
    ...
    plot.title = element_text(size = 14)) +labs(title = "Precision-Sensitivity space plot of Paralogue Annotation", 
    x = "Sensitivity") + theme(axis.text = element_text(size = 13)) + theme(plot.title = element_text(hjust = 0.5)) 
ggsave("/media/nick/821ED5711ED55F2B/Users/Nick/Documents/PhD/Paralogues/ParalogueAnnotation_personal/images/PRC_of_SCN5A.png")
