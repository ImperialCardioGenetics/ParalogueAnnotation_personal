...
dens = ggplot(data2, aes(x = variants, y = annotations)) +
  ...
  ylab(expression(log[10](number~of~annotations~per~variant))) + xlab("number of variants") + theme(axis.title = element_text(size = 15), 
    axis.text = element_text(size = 15), 
    plot.title = element_text(size = 15), 
    legend.text = element_text(size = 12), 
    legend.title = element_text(size = 12))
...
dens2 = ggplot(data2, aes(x = genes, y = variants)) +
  ...
  coord_trans(y="log10") +
  scale_y_continuous(breaks = c(1,2,3,4,5,10,20,30,40,50,100,200,300,400,500,600)) +
  ylab(expression(log[10](number~of~variants~per~gene))) + xlab("number of genes") + theme(axis.title = element_text(size = 15), 
    axis.text = element_text(size = 15), 
    plot.title = element_text(size = 15), 
    legend.text = element_text(size = 12), 
    legend.title = element_text(size = 12))
...
SCN5A_disease_rare_variant_cases = sum(as.numeric(disease_data_ref[disease_data_ref$gene_symbol == "SCN5A" & disease_data_ref$mut_id %in% rare_disease_cohort_variants$ID &
                                                                     (disease_data_ref$Protein_position < 130 |
                                                                        disease_data_ref$Protein_position > 422) &
                                                                     (disease_data_ref$Protein_position < 718 |
                                                                        disease_data_ref$Protein_position > 943) &
                                                                     (disease_data_ref$Protein_position < 1204 |
                                                                        disease_data_ref$Protein_position > 1479) &
                                                                     (disease_data_ref$Protein_position < 1528 |
                                                                        disease_data_ref$Protein_position > 1782)
                                                                     , "cases"]))
#individual cases for variants predicted pathogenic by PA
disease.paralogous_var_align = Paralogous_var_align("data/LQTS/rare_disease_cohort_variants.out_paraloc_paralogs2.noQC", "data/LQTS/rare_disease_cohort_variants.out_paraloc_tableized", "data/clinvar/clinvar_20181028_GRCh37_onlyPathogenic_and_Likely_pathogenic.out_paraloc_tableized")
...
Protein_pos_select = disease.paralogous_var_align$Total_paralog_annotations[!is.na(disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x) &
                                                                              (disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x < 130 |
                                                                                 disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x > 422) &
                                                                              (disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x < 718 |
                                                                                 disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x > 943) &
                                                                              (disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x < 1204 |
                                                                                 disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x > 1479) &
                                                                              (disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x < 1528 |
                                                                                 disease.paralogous_var_align$Total_paralog_annotations$Protein_position.x > 1782),]
...
SCN5A_control_rare_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$ID %in% gnomad_rare_variants$ID &
                                                                     (control_data_ref$Protein_position < 130 |
                                                                        control_data_ref$Protein_position > 422) &
                                                                     (control_data_ref$Protein_position < 718 |
                                                                        control_data_ref$Protein_position > 943) &
                                                                     (control_data_ref$Protein_position < 1204 |
                                                                        control_data_ref$Protein_position > 1479) &
                                                                     (control_data_ref$Protein_position < 1528 |
                                                                        control_data_ref$Protein_position > 1782)
                                                                     , "Allele.Count"]))
#individual cases for variants predicted pathogenic by PA
control.paralogous_var_align = Paralogous_var_align("data/LQTS/gnomAD_v2.1.1_LQTS_variants_rare.out_paraloc_paralogs2.noQC", "data/LQTS/gnomAD_v2.1.1_LQTS_variants_rare.out_paraloc_tableized", "data/clinvar/clinvar_20181028_GRCh37_onlyPathogenic_and_Likely_pathogenic.out_paraloc_tableized") 
#finding only protein positions that are not transmembrane domains identified by pfam
Protein_pos_select = control.paralogous_var_align$Total_paralog_annotations[!is.na(control.paralogous_var_align$Total_paralog_annotations$Protein_position.x) &
                                                                              (control.paralogous_var_align$Total_paralog_annotations$Protein_position.x < 130 |
                                                                                 control.paralogous_var_align$Total_paralog_annotations$Protein_position.x > 422) &
                                                                              (control.paralogous_var_align$Total_paralog_annotations$Protein_position.x < 718 |
                                                                                 control.paralogous_var_align$Total_paralog_annotations$Protein_position.x > 943) &
                                                                              (control.paralogous_var_align$Total_paralog_annotations$Protein_position.x < 1204|
                                                                                 control.paralogous_var_align$Total_paralog_annotations$Protein_position.x > 1479) &
                                                                              (control.paralogous_var_align$Total_paralog_annotations$Protein_position.x < 1528|
                                                                                 control.paralogous_var_align$Total_paralog_annotations$Protein_position.x > 1782),]
