...
# disease_genes_wide[disease_genes_wide$paralogue == "Yes", "paralogue"] = "Disease_Yes"
# disease_genes_wide[disease_genes_wide$paralogue == "No", "paralogue"] = "Disease_No"
# all_protein_genes[all_protein_genes$paralogue == "Yes", "paralogue"] = "Total_Yes"
# all_protein_genes[all_protein_genes$paralogue == "No", "paralogue"] = "Total_No"
...
dens = ggplot(total_plot_data, aes(x=number_of_paralogues)) + 
  geom_histogram(data = total_plot_data[total_plot_data$disease=="Yes" & total_plot_data$paralogue == "Yes",], fill = "red", alpha = 1, binwidth = 1) +
    geom_histogram(data = total_plot_data[total_plot_data$disease=="Yes" & total_plot_data$paralogue == "No",], fill = "blue", alpha = 0.5, binwidth = 1) +
  geom_histogram(data = total_plot_data[total_plot_data$disease=="No" & total_plot_data$paralogue == "Yes",], fill = "green", alpha = 1, binwidth = 1) +
  geom_histogram(data = total_plot_data[total_plot_data$disease=="No" & total_plot_data$paralogue == "No",], fill = "orange", alpha = 0.5, binwidth = 1)

  
  aes(color = paralogue), fill = "white", positions = "identity", binwidth = 1, alpha = 0.5)
...
COL3A1_annotations = p.var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "COL3A1" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
...
COL4A5_annotations = p.var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "COL4A5" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
...
SCN1A_annotations = p.var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "SCN1A" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
...
COL1A1_annotations = p.var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "COL1A1" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
...
COL1A2_annotations = p.var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "COL1A2" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
