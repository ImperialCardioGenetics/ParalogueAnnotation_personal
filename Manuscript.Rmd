...
write.table(unique(c(unique(clinvar_P_LP_only_snv_missense_tableized$SYMBOL), unique(clinvar_B_LB_only_snv_missense_tableized$SYMBOL))),file="data/clinvar/4340_clinvar_genes_w_only_missense.txt", na="", row.names = FALSE, col.names = FALSE, sep = ",", quote=FALSE)
...
#can just join clinvar_B_LB_only_snv_missense_tableized to y to identify number that should replace 14788, i.e. like paralog_data immediately above
