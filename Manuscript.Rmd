...
# for (row in 1:5){
  ...
  for (paralog in paralogs){
    ...
    potential_anno = potential_anno + length(missense_var) #There's 225649 potentially informative annotations
  }
}
...
p.var_in_genes_unique_var = p.var_in_genes_unique_var[p.var_in_genes_unique_var$Var1 %in% clinvar_P_LP_tableized_genes,] #643 HERE!!!
...
num_of_var_clinvar_P_LP_only_snv_missense_tableized = length(unique(clinvar_P_LP_only_snv_missense_tableized$ID)) #43136
num_of_genes_clinvar_P_LP_only_snv_missense_tableized = length(unique(clinvar_P_LP_only_snv_missense_tableized$SYMBOL)) #3631
...
length(unique(intersect(x$Gene, clinvar_P_LP_only_snv_missense_tableized$SYMBOL))) #2451
...
num_of_var_clinvar_B_LB_only_snv_missense_tableized = length(unique(clinvar_B_LB_only_snv_missense_tableized$ID)) #19112
num_of_genes_clinvar_B_LB_only_snv_missense_tableized = length(unique(clinvar_B_LB_only_snv_missense_tableized$SYMBOL)) #3007

total_num_of_genes_clinvar_P_LP_B_LB_only_snv_missense_tableized = length(unique(c(unique(clinvar_P_LP_only_snv_missense_tableized$SYMBOL), unique(clinvar_B_LB_only_snv_missense_tableized$SYMBOL)))) #4340
