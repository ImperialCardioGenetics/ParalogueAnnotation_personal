...
gg5 = ggplot(other_tools_data, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  xlim(0,1) + ylim(0.8,1)  + theme(plot.subtitle = element_text(vjust = 1),
    ...
    plot.title = element_text(size = 14)) + theme(axis.text = element_text(size = 25)) + theme(plot.title = element_text(hjust = 0.5)) + 
...
gg = ggplot(other_tools_data, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  xlim(0,1) + ylim(0.8,1)  + theme(plot.subtitle = element_text(vjust = 1),
    plot.caption = element_text(vjust = 1), 
    plot.title = element_text(size = 14)) +labs(y = "PPV", x = "Sensitivity") + theme(legend.position="none", axis.text = element_text(size = 25), axis.title.x=element_blank(), axis.title.y=element_blank()) + theme(legend.key.size = unit(2,"line"))
...
gg = ggplot(other_tools_data, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  xlim(0,1) + ylim(0.8,1)  + theme(plot.subtitle = element_text(vjust = 1),
    plot.caption = element_text(vjust = 1), 
    axis.title = element_text(size = 16), 
    plot.title = element_text(size = 14)) +labs(y = "PPV", x = "Sensitivity") + theme(legend.text=element_text(size=16), axis.text = element_text(size = 16), axis.title.x=element_blank(), axis.title.y=element_blank()) + theme(plot.title = element_text(hjust = 0.25)) + theme(legend.key.size = unit(5,"line"))
...
gg = ggplot(df1, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  xlim(0,1) + ylim(0,1)  + theme(plot.subtitle = element_text(vjust = 1),
    ...
    axis.title = element_text(size = 16), 
    plot.title = element_text(size = 14),
    legend.position="none", axis.text = element_text(size = 25), axis.title.x=element_blank(), axis.title.y=element_blank()) + theme(plot.title = element_text(hjust = 0.25)) 
...
gg = ggplot(df1, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  xlim(0,1) + ylim(0,1)  + theme(plot.subtitle = element_text(vjust = 1),
    plot.caption = element_text(vjust = 1), 
    axis.title = element_text(size = 16), 
    plot.title = element_text(size = 14)) + theme(legend.position="none", axis.text = element_text(size = 25), axis.title.x=element_blank(), axis.title.y=element_blank()) + theme(plot.title = element_text(hjust = 0.25)) 
