...
var_in_genes_unique_var = data.frame(table(p.paralogous_var_align$Unique_variant_annotations$Gene))
...
var_in_genes_unique_var = data.frame(table(b.paralogous_var_align$Unique_variant_annotations$Gene))
