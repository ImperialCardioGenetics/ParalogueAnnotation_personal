...
The revel scores were converted from csv to tsv using some bash and binary indexed using tabix for faster lookup. Then python script __/rds/general/user/nyl112/home/WORK/data/REVEL_scores/extract_revel_score.py__ was used to annotate the tableized file with the revel scores.
