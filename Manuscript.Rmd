...
p.normal_PA = Paralogous_var_align(
  paste0("data/gnomad_exome_r2.1.1/gnomad.exomes.r2.1.1.sites_split0",i,"_only_var_info.out_paraloc_paralogs2.noQC"), paste0("data/gnomad_exome_r2.1.1/gnomad.exomes.r2.1.1.sites_split0",i,"_only_var_info.out_paraloc_tableized"), "data/clinvar/clinvar_20181028_GRCh37_onlyPathogenic_and_Likely_pathogenic.out_paraloc_tableized")
...
for (i in 10:17){
p.normal_PA = Paralogous_var_align(
  paste0("data/gnomad_exome_r2.1.1/gnomad.exomes.r2.1.1.sites_split",i,"_only_var_info.out_paraloc_paralogs2.noQC"), paste0("data/gnomad_exome_r2.1.1/gnomad.exomes.r2.1.1.sites_split",i,"_only_var_info.out_paraloc_tableized"), "data/clinvar/clinvar_20181028_GRCh37_onlyPathogenic_and_Likely_pathogenic.out_paraloc_tableized")
num_of_var_pred_patho = num_of_var_pred_patho + p.normal_PA$true_num_of_paralog_anno
var_pred_patho = rbind(var_pred_patho,p.normal_PA$Unique_variant_annotations[c("Variant_pos","REF.x","ALT.x")])
}
for (i in 18:25){
