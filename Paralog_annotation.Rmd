...
The revel scores were converted from csv to tsv using some bash and binary indexed using tabix for faster lookup. Then python script __/data/Share/nick/Paralog_Anno/data_files/REVEL_scores/
