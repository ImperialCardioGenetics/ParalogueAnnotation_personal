...
clinvar_set_only_P = data.frame(bar = c("Total variants", "Paralogue Annotation", "conserved AA", "full conserved AA", "conserved AA +\nconserved variants", "full conserved AA +\nconserved variants"),
           Pathogenic_var = clinvar_set_csv[1:6,1],
           Stage = "Pathogenic")
clinvar_set_only_P$Stage = factor(clinvar_set_only_P$Stage, levels = c("Pathogenic"))
clinvar_set_only_B = data.frame(bar = c("Total variants", "Paralogue Annotation", "conserved AA", "full conserved AA", "conserved AA +\nconserved variants", "full conserved AA +\nconserved variants"),
           Pathogenic_var = clinvar_set_csv[1:6,2],
           Stage = "Benign")
...
Total_clinvar_set$bar = factor(Total_clinvar_set$bar, levels = c("Total variants", "Paralogue Annotation", "conserved AA", "full conserved AA", "conserved AA +\nconserved variants", "full conserved AA +\nconserved variants"))
...
gg_protein_class = ggplot(total_protein_class, aes(y=number_of_genes, x=reorder(Protein_class, number_of_genes), fill = stage)) +
  ...
  scale_fill_manual(values=c( "#BB8FCE", "#85C1E9")) + 
  guides(fill = guide_legend(reverse=TRUE)) +
  scale_y_continuous(breaks = c(0,50,100,150,200,250,300,350,400)) +
  xlab("PANTHER Protein Class") + theme(legend.key.size = unit(2,"line")) +ylab("Number of Genes")
