...
Paralogue_Annotation_no_QC = c(format(conf$con_table[2], scientific = FALSE),format(conf$con_table[4], scientific = FALSE),round(conf$PPV, digits = 3),round(conf$Sensitivity, digits = 3),round(conf$Specificity, digits = 3),signif(conf$Pvalue$p.value, digits = 3))
Variants_remaining_after_PA_QC1 = c(format(conf2$con_table[2], scientific = FALSE),format(conf2$con_table[4], scientific = FALSE),round(conf2$PPV, digits = 3), round(conf2$Sensitivity, digits = 3),round(conf2$Specificity, digits = 3), signif(conf2$Pvalue$p.value, digits = 3))
Variants_removed_after_PA_QC1 = c(format(var_removed$con_table[2], scientific = FALSE),format(var_removed$con_table[4], scientific = FALSE),round(var_removed$PPV, digits = 3),round(var_removed$Sensitivity, digits = 3),round(var_removed$Specificity, digits = 3),signif(var_removed$Pvalue$p.value, digits = 3))
Variants_remaining_after_PA_QC2 = c(format(conf3$con_table[2], scientific = FALSE),format(conf3$con_table[4], scientific = FALSE),round(conf3$PPV, digits = 3),round(conf3$Sensitivity, digits = 3),round(conf3$Specificity, digits = 3),signif(conf3$Pvalue$p.value, digits = 3))
Variants_removed_after_PA_QC2 = c(format(var_removed2$con_table[2], scientific = FALSE),format(var_removed2$con_table[4], scientific = FALSE),round(var_removed2$PPV, digits = 3),round(var_removed2$Sensitivity, digits = 3),round(var_removed2$Specificity, digits = 3),signif(var_removed2$Pvalue$p.value, digits = 3))
Variants_remaining_after_PA_QC3 = c(format(conf4$con_table[2], scientific = FALSE),format(conf4$con_table[4], scientific = FALSE),round(conf4$PPV, digits = 3),round(conf4$Sensitivity, digits = 3),round(conf4$Specificity, digits = 3),signif(conf4$Pvalue$p.value, digits = 3))
Variants_removed_after_PA_QC3 = c(format(var_removed3$con_table[2], scientific = FALSE),format(var_removed3$con_table[4], scientific = FALSE),round(var_removed3$PPV, digits = 3),round(var_removed3$Sensitivity, digits = 3),round(var_removed3$Specificity, digits = 3),signif(var_removed3$Pvalue$p.value, digits = 3))
...
Variant = c("Pathogenic variants","Benign variants","PPV","Sensitivity","Specificity","P value")
Total = c(length(p.paralogous_var_align$paralog_data$ID),length(b.paralogous_var_align$paralog_data$ID),"NA","NA","NA","NA")
Paralogue_Annotation_no_QC = c(format(conf_b$con_table[2], scientific = FALSE),format(conf_b$con_table[4], scientific = FALSE),round(conf_b$PPV, digits = 3),round(conf_b$Sensitivity, digits = 3),round(conf_b$Specificity, digits = 3),signif(conf_b$Pvalue$p.value, digits = 3))
Variants_remaining_after_PA_QC1 = c(format(conf_b2$con_table[2], scientific = FALSE),format(conf_b2$con_table[4], scientific = FALSE),round(conf_b2$PPV, digits = 3), round(conf_b2$Sensitivity, digits = 3),round(conf_b2$Specificity, digits = 3), signif(conf_b2$Pvalue$p.value, digits = 3))
Variants_removed_after_PA_QC1 = c(format(var_removed_b$con_table[2], scientific = FALSE),format(var_removed_b$con_table[4], scientific = FALSE),round(var_removed_b$PPV, digits = 3),round(var_removed_b$Sensitivity, digits = 3),round(var_removed_b$Specificity, digits = 3),signif(var_removed_b$Pvalue$p.value, digits = 3))
Variants_remaining_after_PA_QC2 = c(format(conf_b3$con_table[2], scientific = FALSE),format(conf_b3$con_table[4], scientific = FALSE),round(conf_b3$PPV, digits = 3),round(conf_b3$Sensitivity, digits = 3),round(conf_b3$Specificity, digits = 3),signif(conf_b3$Pvalue$p.value, digits = 3))
Variants_removed_after_PA_QC2 = c(format(var_removed_b2$con_table[2], scientific = FALSE),format(var_removed_b2$con_table[4], scientific = FALSE),round(var_removed_b2$PPV, digits = 3),round(var_removed_b2$Sensitivity, digits = 3),round(var_removed_b2$Specificity, digits = 3),signif(var_removed_b2$Pvalue$p.value, digits = 3))
Variants_remaining_after_PA_QC3 = c(format(conf_b4$con_table[2], scientific = FALSE),format(conf_b4$con_table[4], scientific = FALSE),round(conf_b4$PPV, digits = 3),round(conf_b4$Sensitivity, digits = 3),round(conf_b4$Specificity, digits = 3),signif(conf_b4$Pvalue$p.value, digits = 3))
Variants_removed_after_PA_QC3 = c(format(var_removed_b3$con_table[2], scientific = FALSE),format(var_removed_b3$con_table[4], scientific = FALSE),round(var_removed_b3$PPV, digits = 3),round(var_removed_b3$Sensitivity, digits = 3),round(var_removed_b3$Specificity, digits = 3),signif(var_removed_b3$Pvalue$p.value, digits = 3))
...
rownames(clinvar_set_benign) = c("Total variants", "Paralogue Annotation", "Variants remaining after QC1", "Variants removed from QC1", "Variants remaining after QC2", "Variants removed after QC2", "Variants remaining after QC3", "Variants removed after QC3")
...
# p.paraz_var_align = ParaZ_var_align(i,"data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_paralogs2.noQC", "data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_tableized")
  p.paraz_var_align = Paralogous_var_align(paraz_cutoff = i,"data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_paralogs2.noQC", "data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_tableized")
...
# b.paraz_var_align = ParaZ_var_align(i,"data/clinvar/clinvar_alleles.single.b38.Benign_and_LikelyBenign.out_paraloc_paralogs2.noQC", "data/clinvar/clinvar_alleles.single.b38.Benign_and_LikelyBenign.out_paraloc_tableized", "data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_tableized")
  b.paraz_var_align = Paralogous_var_align(paraz_cutoff = i,"data/clinvar/clinvar_alleles.single.b38.Benign_and_LikelyBenign.out_paraloc_paralogs2.noQC", "data/clinvar/clinvar_alleles.single.b38.Benign_and_LikelyBenign.out_paraloc_tableized", "data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_tableized")
...
ggplot(roc_data, aes(x=FPR, y=Sensitivity, colour = cutoff)) + geom_point() + xlim(0,0.1) + ylim(0.2,0.3) + scale_color_gradient(low="blue", high="red", limits=c(0, 11))
...
ggplot(prc_data, aes(x=Sensitivity, y=Precision, colour = cutoff)) + geom_point() + xlim(0.2,0.3) + ylim(0.9,1) + scale_color_gradient(low="blue", high="red", limits=c(0, 11))
...
p.sarco_var_align = Paralogous_var_align(Subset = c("Gene","MYH7","MYBPC3","TNNT2","TPM1","MYL2","MYL3","TNNI3","ACTC1"),"data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_paralogs2.noQC", "data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_tableized")
...
p2.sarco_var_align = Paralogous_var_align(Subset = c("Gene","MYH7","MYBPC3","TNNT2","TPM1","MYL2","MYL3","TNNI3","ACTC1"),"data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_paralogs2.para_con", "data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_tableized")
...
p3.sarco_var_align = Paralogous_var_align(Subset = c("Gene","MYH7","MYBPC3","TNNT2","TPM1","MYL2","MYL3","TNNI3","ACTC1"),"data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_paralogs2.all_con", "data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_tableized")
...
p.art.paralogous_var_align = Paralogous_var_align(Subset = c("Gene", gene_subset), "data/all_possible_mutations/remapped_cm_mutation_vep_canon_wRefAl.out_paraloc_paralogs2.noQC.gz", "data/all_possible_mutations/remapped_cm_mutation_vep_canon_wRefAl.out_paraloc_tableized.gz", "data/clinvar/clinvar_alleles.single.b38.Pathogenic_and_LikelyPathogenic.out_paraloc_tableized")
...
gene_EFs = dplyr::bind_rows(gene_EFs,data.frame(gene="Overall",toString(all_rare_vars$OR),toString(all_rare_vars$OR_CI),toString(all_rare_vars$EF),toString(all_rare_vars$EF_CI),toString(pa_predicted_rare_vars$OR),toString(pa_predicted_rare_vars$OR_CI),toString(pa_predicted_rare_vars$EF),toString(pa_predicted_rare_vars$EF_CI)))
...
other_tools_set = t(data.frame(
  ...
  Sift = c(sapply(c(sift_conf$con_table[2],sift_conf$con_table[4]),format,scientific = FALSE),
           sapply(c(sift_conf$PPV,sift_conf$Sensitivity,sift_conf$Specificity,sift_conf$Pvalue$p.value),signif,digits=3)),
  MCap = c(sapply(c(mcap_conf$con_table[2],mcap_conf$con_table[4]),format,scientific = FALSE),
           sapply(c(mcap_conf$PPV,mcap_conf$Sensitivity,mcap_conf$Specificity,mcap_conf$Pvalue$p.value),signif,digits=3)),
  Revel = c(sapply(c(revel_conf$con_table[2],revel_conf$con_table[4]),format,scientific = FALSE),
            sapply(c(revel_conf$PPV,revel_conf$Sensitivity,revel_conf$Specificity,revel_conf$Pvalue$p.value),signif,digits=3)),
  PA.noQC = c(sapply(c(normal_PA_conf$con_table[2],normal_PA_conf$con_table[4]),format,scientific = FALSE),
         sapply(c(normal_PA_conf$PPV,normal_PA_conf$Sensitivity,normal_PA_conf$Specificity,normal_PA_conf$Pvalue$p.value),signif,digits=3)),
  PA.para_con = c(sapply(c(normal_PA2_conf$con_table[2],normal_PA2_conf$con_table[4]),format,scientific = FALSE),
                  sapply(c(normal_PA2_conf$PPV,normal_PA2_conf$Sensitivity,normal_PA2_conf$Specificity,normal_PA2_conf$Pvalue$p.value),signif,digits=3)),
  PA.all_con = c(sapply(c(normal_PA3_conf$con_table[2],normal_PA3_conf$con_table[4]),format,scientific = FALSE),
                 sapply(c(normal_PA3_conf$PPV,normal_PA3_conf$Sensitivity,normal_PA3_conf$Specificity,normal_PA3_conf$Pvalue$p.value),signif,digits=3)),
  PA.alt_con = c(sapply(c(normal_PA4_conf$con_table[2],normal_PA4_conf$con_table[4]),format,scientific = FALSE),
                 sapply(c(normal_PA4_conf$PPV,normal_PA4_conf$Sensitivity,normal_PA4_conf$Specificity,normal_PA4_conf$Pvalue$p.value),signif,digits=3))
))
colnames(other_tools_set) = c("Pathogenic variants","Benign variants","PPV","Sensitivity","Specificity","P value")
