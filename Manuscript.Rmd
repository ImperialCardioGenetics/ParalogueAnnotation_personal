...
b.Sift_Revel_var_align = Sift_Revel_var_align("data/clinvar/clinvar_20181028_GRCh37_onlyBenign_and_Likely_benign.out_paraloc_paralogs2.noQC", sift_revel_data, "data/clinvar/clinvar_20181028_GRCh37_onlyBenign_and_Likely_benign.out_paraloc_tableized")
b.Sift_Revel_var_align$Total_paralog_annotations = b.Sift_Revel_var_align$Total_paralog_annotations[!is.na(p.Sift_Revel_var_align$Total_paralog_annotations$REVEL_score)&!is.na(p.Sift_Revel_var_align$Total_paralog_annotations$SIFT_score),]
b.num_of_sift = length(which(p.Sift_Revel_var_align$Total_paralog_annotations$SIFT_pred == "T"))
b.num_of_revel = length(which(p.Sift_Revel_var_align$Total_paralog_annotations$REVEL_score <= 0.5))
```
