...
CALM_variants = read.csv(file="data/CALM_gene_variants.csv", sep = ",", header=TRUE, stringsAsFactors=FALSE) 
...
write.table(CALM_variants,file="data/CALM_gene_variants.vcf", na="", row.names = FALSE, col.names = TRUE, sep = "\t", quote=FALSE)

CALM_pa = Paralogous_var_align("data/clinvar/clinvar_20190114_GRCh38_onlyPathogenic_and_Likely_pathogenic.out_paraloc_paralogs2.noQC", "data/clinvar/clinvar_20190114_GRCh38_onlyPathogenic_and_Likely_pathogenic.out_paraloc_tableized")
