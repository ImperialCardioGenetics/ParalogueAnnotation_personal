...
gg2 = ggplot(prc_data, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=4) + 
  ...
  theme(legend.text=element_text(size=16), legend.key.size = unit(3,"line"))
...
other_tools_data$Type = c("Sift", "MCap", "CADD", "Revel", "any", "conserved AA" ,"full conserved AA", "full conserved AA +\nconserved variants", "conserved AA +\nconserved variants")
# other_tools_data = rbind(other_tools_data, prc_data2[1:4,])
other_tools_data$Type = factor(other_tools_data$Type, levels = c("Sift", "MCap", "CADD", "Revel", "any", "conserved AA" , "full conserved AA", "conserved AA +\nconserved variants", "full conserved AA +\nconserved variants"))
...
cols = c("Sift" = "#4D5656", "MCap" = "#424949", "CADD" = "#1B2631", "Revel" = "#17202A", "any" = "#58D68D", "conserved AA"  = "#45B39D", "full conserved AA" = "#5DADE2", "conserved AA +\nconserved variants" = "#A569BD", "full conserved AA +\nconserved variants" = "#EC7063")
shapes = c("Sift" = 0, "MCap" = 1, "CADD" = 2, "Revel" = 5, "any" = 15, "conserved AA" = 16, "full conserved AA" = 17, "conserved AA +\nconserved variants" = 18, "full conserved AA +\nconserved variants" = 19)
