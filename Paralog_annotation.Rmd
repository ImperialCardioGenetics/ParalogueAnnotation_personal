...
```{r echo = FALSE, warning=FALSE, fig.cap = cap}
...
In total, `r conf$con_table[1]` Pathogenic and Likely Pathogenic (P/LP) variants and `r conf$con_table[2]` Benign and Likey Benign (B/LB) variants from clinvar had paralogue annotations. With no quality control `r conf$con_table[2]` P/LP  and `r conf$con_table[4]` B/LB variants were predicted to be pathogenic, given a PPV and sensitivity of `r conf$PPV` and `r conf$Sensitivity` respectively. 
