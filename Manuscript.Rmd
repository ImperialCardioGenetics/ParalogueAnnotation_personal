...
prc_data[17,5]="QC1+QC3"

# prc_data[18:21,5]=c("Sift", "MCap", "CADD", "Revel")

prc_data$Type = factor(prc_data$Type, levels = c("no QC", "QC1", "QC1+Para_Z", "QC1+QC2", "QC1+QC3", "QC1+QC2+QC3"))
# prc_data$Type = factor(prc_data$Type, levels = c("Sift", "MCap", "CADD", "Revel", "no QC", "QC1", "QC1+Para_Z", "QC1+QC2", "QC1+QC3", "QC1+QC2+QC3"))

prc_data$Type[1:12] = "QC1+Para_Z"
# gg2 = ggplot(prc_data, aes(x=Sensitivity, y=Precision, colour=cutoff)) + geom_point() + xlim(0,1) + ylim(0,1)
# gg2 = gg2 + geom_abline(intercept = 0, slope = 1, linetype = "dotted")
# 
# ggplot(prc_data, aes(x=Sensitivity, y=Precision, colour = cutoff)) + geom_point() + xlim(0.1,0.2) + ylim(0.85,1) + scale_color_gradient(low="blue", high="red", limits=c(0, 11))
cols = c("QC1+Para_Z" = "#4D5656", "no QC" = "#58D68D", "QC1" = "#45B39D", "QC1+QC2" = "#5DADE2", "QC1+QC3" = "#A569BD", "QC1+QC2+QC3" = "#EC7063")
shapes = c("QC1+Para_Z" = 6, "no QC" = 15, "QC1" = 16, "QC1+QC2" = 17, "QC1+QC3" = 18, "QC1+QC2+QC3" = 19)
...
ggsave("images/PRC_with_other_tools_with_QC3_QC1_no_QC2.png", width = 10, height = 11)
