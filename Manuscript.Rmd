...
p.Sift_Revel_var_align = Sift_Revel_var_align("data/clinvar/clinvar_20181028_GRCh37_onlyPathogenic_and_Likely_pathogenic.out_paraloc_paralogs2.all_con", sift_revel_data, "data/clinvar/clinvar_20181028_GRCh37_onlyPathogenic_and_Likely_pathogenic.out_paraloc_tableized")
...
p.Total_number_of_vars = dim(p.Sift_Revel_var_align$Total_paralog_annotations)[1]
...
btop.Total_number_of_vars = dim(btop.Sift_Revel_var_align$Total_paralog_annotations)[1]
...
data.frame(c(p.Total_number_of_vars,btop.Total_number_of_vars),c(p.num_of_paralog_anno,btop.num_of_paralog_anno),c(p.num_of_revel,btop.num_of_revel),c(p.num_of_sift,btop.num_of_sift))
...
ptob.Total_number_of_vars = dim(ptob.Sift_Revel_var_align$Total_paralog_annotations)[1]
...
b.Total_number_of_vars = dim(b.Sift_Revel_var_align$Total_paralog_annotations)[1]
