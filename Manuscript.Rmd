...
genes in Ensembl and their associated paralogues")+ylim(0,6000)
ggsave("/media/nick/821ED5711ED55F2B/Users/Nick/Documents/PhD/Paralogues/ParalogueAnnotation_personal/images/Total_genes_paralogs.png")
...
in disease in Ensembl and their associated paralogues")
ggsave("/media/nick/821ED5711ED55F2B/Users/Nick/Documents/PhD/Paralogues/ParalogueAnnotation_personal/images/Disease_genes_paralogs.png")
...
gg = ggplot(roc_data, aes(x=FPR, y=Sensitivity, colour = Type)) + geom_point(size=2) + xlim(0,0.05) + ylim(0,0.25) + theme(plot.subtitle = element_text(vjust = 1), 
    ...
    plot.title = element_text(size = 14, 
        hjust = 0.25)) +labs(title = "Receiver operating characteristic
space plot of Paralogue Annotation")
...
gg2 = ggplot(prc_data, aes(x=Sensitivity, y=Precision, colour = Type)) + geom_point(size=2) + xlim(0,0.25) + ylim(0.85,1)  + theme(plot.subtitle = element_text(vjust = 1), 
    plot.caption = element_text(vjust = 1), 
    axis.title = element_text(size = 16), 
    plot.title = element_text(size = 14)) +labs(title = "Precision-Recall space plot of Paralogue Annotation", 
    x = "Recall") + theme(axis.text = element_text(size = 13))
