...
max_no_col = (max(count.fields(art.paralog_data, sep = "\t"))-4)
art.paralog_data = read.csv(file="/media/nick/Data/Users/N/Documents/PhD/Paralogues/data_files/all_possible_mutation_icc/cm_mutation_vep_canon.out_paraloc_paralogs2.noQC", header = FALSE, sep = "\t", col.names = c("Variant_pos", "ID", "Gene", paste("paralog", 1:max_no_col, sep = "")))
