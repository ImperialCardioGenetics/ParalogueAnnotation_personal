...
Variants_remaining_after_PA_QC3_w_QC1_no_QC2 = c(format(conf6$con_table[2], scientific = FALSE),format(conf6$con_table[4], scientific = FALSE),round(conf6$PPV, digits = 3),round(conf6$Sensitivity, digits = 3),round(conf6$Specificity, digits = 3),signif(conf6$Pvalue$p.value, digits = 3))
...
Variants_removed_after_PA_QC3_w_QC1_no_QC2 = c(format(var_removed4$con_table[2], scientific = FALSE),format(var_removed4$con_table[4], scientific = FALSE),round(var_removed4$PPV, digits = 3),round(var_removed4$Sensitivity, digits = 3),round(var_removed4$Specificity, digits = 3),signif(var_removed4$Pvalue$p.value, digits = 3))
...
other_tools_data$Type = c("Sift", "MCap", "CADD", "Revel", "noQC", "QC1" ,"QC2", "QC3", "QC3 (no QC2)")
# other_tools_data = rbind(other_tools_data, prc_data2[1:4,])
other_tools_data$Type = factor(other_tools_data$Type, levels = c("Sift", "MCap", "CADD", "Revel", "noQC", "QC1" ,"QC2", "QC3", "QC3 (no QC2)"))
...
other_tools_data$Type = c("noQC", "QC1" ,"QC2", "QC3", "QC3 (no QC2)")
# other_tools_data = rbind(other_tools_data, prc_data2[1:4,])
other_tools_data$Type = factor(other_tools_data$Type, levels = c("noQC", "QC1" ,"QC2", "QC3", "QC3 (no QC2)"))
