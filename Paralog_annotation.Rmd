...
In total, `r conf$con_table[1]` Pathogenic and Likely Pathogenic (P/LP) variants and `r conf$con_table[2]` Benign and Likey Benign (B/LB) variants from clinvar were in genes with paralogues. With no quality control `r conf$con_table[2]` pathogenic or likely pathogenic variants were aligned 
