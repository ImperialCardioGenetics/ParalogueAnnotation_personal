...
data_ref = read.csv("data/LQTS/Mayo_LQTS_variants.csv", sep = ",", stringsAsFactors = 0)
data = data_ref[data_ref$mut_protein!="NULL",]

gnomad_KCNE1 = read.csv("data/LQTS/gnomAD_v2.1.1_ENSG00000180509_2019_03_31_15_09_18_KCNE1.csv", sep = ",", stringsAsFactors = 0)
