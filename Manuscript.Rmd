...
roc_data = do.call(rbind, Map(data.frame, Sensitivity = Sensitivity_list, FPR = FPR_list, type = "paraz"))
roc_data = rbind(roc_data, c(Sensitivity=conf$Sensitivity,FPR=conf$FPR,type = "noQC"))
roc_data = rbind(roc_data, c(Sensitivity=conf2$Sensitivity,FPR=conf2$FPR,type = "QC1"))
roc_data = rbind(roc_data, c(Sensitivity=conf3$Sensitivity,FPR=conf3$FPR,type = "QC2"))
