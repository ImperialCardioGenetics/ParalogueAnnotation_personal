...
write.table(genes_not_in_ens,file="data/clinvar/genes_not_in_ens.txt", na="", row.names = FALSE, col.names = FALSE, sep = ",", quote=FALSE)
...
write.table(overlapp_genes, file = "data/clinvar/variants_in_overlapp_genes.csv", na=".", row.names = FALSE, col.names = TRUE, sep = ",", quote=FALSE)
...
colnames(protein_classes) = c("Category name (Accession)", "number of genes", "Percent of gene hit against total number of genes", "Percent of gene hit against total number of Protein Class hits")
