...
if (file.exists("data/NDD+E/notin_discovEHR_gnomad_pred_patho_at_para_con.RData")){
  ...
  rare_gnomad = read.csv(file = paste0("data/NDD+E/gnomad.exomes.r2.1.1.sites.vcf_split0",i,"_notin_discovEHR.csv"), header = T, sep = ",", stringsAsFactors = 0)
  ...
  rare_gnomad = read.csv(file = paste0("data/NDD+E/gnomad.exomes.r2.1.1.sites.vcf_split",i,"_notin_discovEHR.csv"), header = T, sep = ",", stringsAsFactors = 0)
  rare_gnomad$Variant_pos = paste(rare_gnomad$CHROM, rare_gnomad$POS, sep = " ")
  annotated_gnomad = inner_join(p.normal_PA$Unique_variant_annotations, rare_gnomad, by = c("Variant_pos", "REF.x" = "REF", "ALT.x" = "ALT"))
  var_pred_patho = rbind(var_pred_patho,annotated_gnomad)
  }
