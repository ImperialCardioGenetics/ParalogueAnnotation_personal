...
protein_genes_w_paralogues = unique(protein_genes_w_paralogues$external_gene_name)
...
According to ensembl, `r length(protein_genes_w_paralogues)` protein coding genes are defined to have paralogues. While `r length(protein_genes_wo_paralogues)` protein genes do not have paralogues.
