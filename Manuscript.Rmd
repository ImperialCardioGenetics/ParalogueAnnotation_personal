...
total_num_of_genes_clinvar_P_LP_B_LB_only_snv_missense_tableized = length(unique(c(unique(clinvar_P_LP_only_snv_missense_tableized$SYMBOL), unique(clinvar_B_LB_only_snv_missense_tableized$SYMBOL))))
...
# protein_classes = rbind(protein_classes, data.frame(Protein_class = "", number_of_genes = 0, Percent_of_gene_hit_against_total_number_of_genes = 0, Percent_of_gene_hit_against_total_number_of_Protein_Class_hits = 0))
gg_protein_class = ggplot(protein_classes, aes(y=number_of_genes, x=reorder(Protein_class, number_of_genes))) +
