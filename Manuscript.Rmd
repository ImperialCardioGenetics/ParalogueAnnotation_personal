...
Total_variants_bar = ggplot(Total_variants, aes(y=Total.variants, x=Clnsig, fill = Clnsig)) + geom_bar(stat="identity", position="dodge")
...
gg = ggplot(KCNQ1_EF_data, aes(y=type, x=OR, colour = type, shape = type)) + 
  geom_point(size=9) + 
