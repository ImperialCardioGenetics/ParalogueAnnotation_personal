...
"0-9",
"10-99",
"100-263", #174, 175, 228, 261, 262 EXCEEDED MEM
"174,175,228,261,262"
),
done = c(1,1,1,1)
)
...
HPC_run_chrom6 = data.frame(
  file = c(
"0-9",
# "10-99" #SOME FAILED - TOO MANY CONNECTIONS EVEN WHEN CHROM6 RUNNING BY ITSELF
"10-50",
"51-99",
"100-179"
),
...
HPC_run_chrom14 = data.frame(
  file = c(
"0-9", #4+5 ran out of memory, rerun
"10-99",
"100-117"
),
done = c(0,1,1)
...
HPC_run_chrom16 = data.frame(
  file = c(
"0-9", #SOME FAILED - EXCEEDED MEMORY LIMIT
"10-99"#SOME FAILED - TOO MANY CONNECTIONS
),
done = c(0,0)
)
...
HPC_run_chrom18 = data.frame(
  file = c(
"0-9",
"10-56"#SOME FAILED - TOO MANY CONNECTIONS
),
done = c(1,0)
)
...
HPC_run_chrom20 = data.frame(
  file = c(
"0-9",
"10-85"#SOME FAILED - TOO MANY CONNECTIONS
),
done = c(1,0)
)
...
HPC_run_chrom21 = data.frame(
  file = c(
"0-9",
"10-36"#SOME FAILED - TOO MANY CONNECTIONS
),
done = c(1,0)
)
...
HPC_run_chrom22 = data.frame(
  file = c(
"0-9",
"10-77"#SOME FAILED - TOO MANY CONNECTIONS
),
done = c(1,0)
)
...
HPC_run_chromY = data.frame(
  file = c(
"0-9",
"10-11"#SOME FAILED - TOO MANY CONNECTIONS
),
done = c(1,0)
)
```
