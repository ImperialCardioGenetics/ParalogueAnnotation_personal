...
var_in_genes_unique_var = data.frame(table(var_in_genes$Unique_variant_annotations$Gene))
write.table(var_in_genes_unique_var, file = "data/clinvar/genes_with_number_of_annotations_noQC.csv", na="", row.names = FALSE, col.names = TRUE, sep = ",", quote=FALSE)
#top 5 genes where PA performs best with clinvar data
COL3A1_annotations = var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "COL3A1" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
COL3A1_annotations_genes = data.frame(table(COL3A1_annotations$SYMBOL))
COL4A5_annotations = var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "COL4A5" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
COL4A5_annotations_genes = data.frame(table(COL4A5_annotations$SYMBOL))
SCN1A_annotations = var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "SCN1A" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
SCN1A_annotations_genes = data.frame(table(SCN1A_annotations$SYMBOL))
COL1A1_annotations = var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "COL1A1" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
COL1A1_annotations_genes = data.frame(table(COL1A1_annotations$SYMBOL))
COL1A2_annotations = var_in_genes$Total_paralog_annotations[var_in_genes$Total_paralog_annotations$Gene == "COL1A2" & !is.na(var_in_genes$Total_paralog_annotations$ID.y),]
...
gg2 = ggplot(prc_data, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=4) + 
  ...
  scale_shape_manual(values=c(15, 1, 16, 17, 18)) + xlim(0,0.25) + ylim(0.85,1)  + theme(plot.subtitle = element_text(vjust = 1), 
    ...
    plot.title = element_text(size = 14)) +labs(title = "Precision-Sensitivity space plot of Paralogue Annotation", 
    x = "Sensitivity") + theme(axis.text = element_text(size = 13)) + theme(plot.title = element_text(hjust = 0.5))
ggsave("images/PRC_plot_paraz_with_QC1.png")
...
#individual cases for rare variants
KCNE1_control_rare_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "KCNE1" & control_data_ref$rsID %in% gnomad_rare_variants$ID, "Allele.Count"]))
KCNE2_control_rare_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "KCNE2" & control_data_ref$rsID %in% gnomad_rare_variants$ID, "Allele.Count"]))
KCNH2_control_rare_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "KCNH2" & control_data_ref$rsID %in% gnomad_rare_variants$ID, "Allele.Count"]))
KCNQ1_control_rare_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "KCNQ1" & control_data_ref$rsID %in% gnomad_rare_variants$ID, "Allele.Count"]))
SCN5A_control_rare_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "SCN5A" & control_data_ref$rsID %in% gnomad_rare_variants$ID, "Allele.Count"]))
#individual cases for variants predicted pathogenic by PA
...
control_cohort_data = control_data_ref[control_data_ref$rsID %in% control.paralogous_var_align$Unique_variant_annotations$ID.x,] 
KCNE1_control_pa_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "KCNE1" & control_data_ref$rsID %in% control.paralogous_var_align$Unique_variant_annotations$ID.x, "Allele.Count"]))
KCNE2_control_pa_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "KCNE2" & control_data_ref$rsID %in% control.paralogous_var_align$Unique_variant_annotations$ID.x, "Allele.Count"]))
KCNH2_control_pa_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "KCNH2" & control_data_ref$rsID %in% control.paralogous_var_align$Unique_variant_annotations$ID.x, "Allele.Count"]))
KCNQ1_control_pa_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "KCNQ1" & control_data_ref$rsID %in% control.paralogous_var_align$Unique_variant_annotations$ID.x, "Allele.Count"]))
SCN5A_control_pa_variant_cases = sum(as.numeric(control_data_ref[control_data_ref$Gene == "SCN5A" & control_data_ref$rsID %in% control.paralogous_var_align$Unique_variant_annotations$ID.x, "Allele.Count"]))
...
other_tools_data = data.frame(
  Precision = c(as.numeric(other_tools_set[6:9,3])),
  Precision_CI = c(as.numeric(other_tools_set[6:9,4])),
  Sensitivity = c(as.numeric(other_tools_set[6:9,5])),
  Sensitivity_CI = c(as.numeric(other_tools_set[6:9,6]))
  )
other_tools_data$Type = c("noQC", "QC1" ,"QC2", "QC3")
# other_tools_data = rbind(other_tools_data, prc_data2[1:4,])
other_tools_data$Type = factor(other_tools_data$Type, levels = c("noQC", "QC1" ,"QC2", "QC3"))
...
df1$Type = factor(other_tools_data$Type, levels = c("Sift", "MCap", "CADD", "Revel", "noQC", "QC1" ,"QC2", "QC3"))
