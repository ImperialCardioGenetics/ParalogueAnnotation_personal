...
write.table(aligned_benign_clinvar_and_benign_protein_pos,"data/all_possible_mutations/COL3A1/aligned_benign_clinvar_and_benign_COL3A1_variants.gff", quote = FALSE, sep = "\t", row.names = FALSE, col.names = FALSE, append = TRUE)
