...
dens = ggplot(total_plot_data, aes(x=number_of_paralogues)) + 
  geom_histogram(data = total_plot_data[total_plot_data$disease=="No" & total_plot_data$paralogue == "No",], fill = "red", alpha = 0.5, binwidth = 1) +
  geom_histogram(data = total_plot_data[total_plot_data$disease=="Yes" & total_plot_data$paralogue == "No",], fill = "red", alpha = 1, binwidth = 1) +
  geom_histogram(data = total_plot_data[total_plot_data$disease=="No" & total_plot_data$paralogue == "Yes",], fill = "blue", alpha = 0.5, binwidth = 1) +
  geom_histogram(data = total_plot_data[total_plot_data$disease=="Yes" & total_plot_data$paralogue == "Yes",], fill = "blue", alpha = 1, binwidth = 1) +
...
in disease in Ensembl and their associated paralogues") + theme(axis.title = element_text(size = 15), 
    ...
    legend.text = element_text(size = 12), 
    legend.title = element_text(size = 12))
ggsave("images/Total_and_Disease_genes_paralogs.png")
