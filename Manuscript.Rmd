...
# data = data_ref[data_ref$mut_protein!="NULL",]
...
gnomad_rare_variants = read.csv("data/LQTS/gnomAD_v2.1.1_LQTS_variants_rare.vcf", sep = "\t", stringsAsFactors = 0)

rare_disease_cohort_variants = data.frame()
# disease_cohort_variants = disease_cohort_variants[1:10,]
for (row in 1:nrow(disease_cohort_variants)){
  if (
...
write.table(rare_disease_cohort_variants, file = "data/LQTS/rare_disease_cohort_variants.vcf", na="", row.names = FALSE, col.names = TRUE, sep = "\t", quote=FALSE)
...
control_data_ref = read.csv("data/LQTS/gnomAD_v2.1.1_LQTS_variants.csv", sep = ",", stringsAsFactors = 0)
control_data_ref  = control_data_ref [-c(103,182,1225,1573),] #remove the extra header lines from when concatenated the separate gene csv files together
