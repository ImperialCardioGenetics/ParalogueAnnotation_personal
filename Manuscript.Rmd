...
SCN2A_rare_gnomad = rare_gnomad[rare_gnomad$CHROM == 2 & rare_gnomad$POS >= 166845671 & rare_gnomad$POS <= 166984524,]
...
##rare and paralogue annotated
load("data/NDD+E/notin_discovEHR_gnomad_pred_patho_at_para_con.RData")
SCN2A_var_pred_patho = var_pred_patho[var_pred_patho$CHROM == 2 & var_pred_patho$POS >= 166845671 & var_pred_patho$POS <= 166984524,]
...
SCN1A_annotated_NDD = inner_join(p.annotated_NDD$Unique_variant_annotations,SCN1A_NDD_notin_discovEHR,by = c("Variant_pos"))
