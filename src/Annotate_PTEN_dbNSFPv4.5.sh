...
java -Xmx5g search_dbNSFP45a -v hg19 -i /rds/general/project/lms-ware-analysis/live/nick/ParalogueAnnotation_personal/data/otherMaveDB_score/PTEN_mave_patho_b37.vcf -o /rds/general/project/lms-ware-analysis/live/nick/dbNSFP4.5/dbNSFP45a_PTEN_mave_patho_b37.vcf.out -p -w 1-6,38-40,59-61,77-84,96-101,108-110,122-140,147-149
