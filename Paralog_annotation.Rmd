...
* ~~FIX ISSUE OF KCNA1, e.g look at ```grep -P "\t4912055\t" clinvar_20190114_GRCh38_onlyPathogenic_and_Likely_pathogenic.out_paraloc_paralogs --color``` and compare with ```grep -P "\t4912055\t" clinvar_20190114_GRCh38_onlyPathogenic_and_Likely_pathogenic.out_paraloc_paralogs2.noQC --color```. It has paralogues, but isn't being picked up??!?~~ Nvm, was just being idiot. There are no tabs between the ID; that's why they weren't picking it up.
