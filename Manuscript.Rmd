...
total_EF_data$gene = factor(total_EF_data$gene, levels = c("SCN5A-LQTS","KCNH2","KCNQ1"))
...
total_EF_data$gene = factor(total_EF_data$gene, levels = c("SCN5A-BrS","SCN5A-LQTS","KCNH2","KCNQ1"))
...
KCNQ2_rare_gnomad = rare_gnomad[rare_gnomad$CHROM == 2 & rare_gnomad$POS >= 166845671 & rare_gnomad$POS <= 166984524,]
...
##rare and paralogue annotated
KCNQ2_var_pred_patho = var_pred_patho[var_pred_patho$CHROM == 2 & var_pred_patho$POS >= 166845671 & var_pred_patho$POS <= 166984524,]
