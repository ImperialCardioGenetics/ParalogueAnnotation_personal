...
bar_chart = ggplot(Total_clinvar_set, aes(y=Pathogenic_var, x=bar, fill = Stage, colour = Stage)) + geom_bar(stat="identity", position="dodge") +
  ...
  theme(legend.title = element_blank(),
        ...
        axis.title.x = element_blank(),
        axis.title.y = element_text(size=25)) + ylab("Variants predicted pathogenic") +
  scale_y_continuous(breaks = c(0,1000,2000,3000,4000), limits = c(0,4200), expand = c(0,0)) +
  geom_text(aes(label=Pathogenic_var), position=position_dodge(width=0.9), vjust=-0.25, size = 10, color = "black")
ggsave("images/clinvar_set_bar_chart.png", height = 14, width = 12)
  # scale_y_log10() 
...
gg_protein_class_poster = ggplot(total_protein_class_poster, aes(y=number_of_genes, x=reorder(Protein_class, number_of_genes), fill = stage)) +
  ...
  guides(fill=guide_legend(
                 ...
                 default.unit="inch",
                 reverse = TRUE))
ggsave("images/GO_protein_classes_of_genes2_for_poster.png", height = 8, width = 10)
