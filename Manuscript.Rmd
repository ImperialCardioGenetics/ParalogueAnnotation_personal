...
## Transfer of annotations across paralogues
...
P values are calculated via Fisher's exact test on a 2x2 contingency table tabulating the number of variants of interest and how many 
