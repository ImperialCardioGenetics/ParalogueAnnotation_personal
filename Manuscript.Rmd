...
ggsave("images/PRC_with_other_tools_with_QC3_QC1_no_QC2.png", width = 8, height = 9)
...
gg = ggplot(other_tools_data, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  theme(axis.line.x = element_line(color="black", size = 2),
        axis.line.y = element_line(color="black", size = 2)) +
  theme(legend.position="none", axis.text = element_text(size = 25), axis.title.x=element_blank(), axis.title.y=element_blank()) + theme(legend.key.size = unit(2,"line"))
ggsave("images/PRC_of_SCN5A.png", width = 8, height = 9)
...
gg = ggplot(other_tools_data, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  theme(axis.line.x = element_line(color="black", size = 2),
        axis.line.y = element_line(color="black", size = 2)) +
  theme(legend.text=element_text(size=16), axis.text = element_text(size = 16), axis.title.x=element_blank(), axis.title.y=element_blank()) + theme(plot.title = element_text(hjust = 0.25)) + theme(legend.key.size = unit(5,"line"))
ggsave("images/PRC_of_SCN5A_with_legend.png", width = 8, height = 9)
```
...
ggsave("images/PRC_of_TP53-TA_with_other_tools_plot.png", width = 8, height = 9)
...
gg = ggplot(df1, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  xlim(0,1) + ylim(0,1)  + theme(plot.subtitle = element_text(vjust = 1),
    plot.caption = element_text(vjust = 1), 
    axis.title = element_text(size = 16), 
    plot.title = element_text(size = 14)) + theme(legend.position="none", axis.text = element_text(size = 25), axis.title.x=element_blank(), axis.title.y=element_blank()) +
   theme(plot.background = element_blank(),
         panel.grid.minor = element_blank())+
  theme(axis.line.x = element_line(color="black", size = 2),
        axis.line.y = element_line(color="black", size = 2)) +
  theme(plot.title = element_text(hjust = 0.25)) 
ggsave("images/PRC_of_PPARG_with_other_tools_plot.png", width = 8, height = 9)
...
gg = ggplot(df1, aes(x=Sensitivity, y=Precision, colour = Type, shape = Type)) + geom_point(size=7) + 
  ...
  theme(axis.line.x = element_line(color="black", size = 2),
        axis.line.y = element_line(color="black", size = 2)) +
  theme(plot.title = element_text(hjust = 0.25)) 
ggsave("images/PRC_of_SSC_with_other_tools_plot.png", width = 8, height = 9)
```
