...
bar_chart = ggplot(df, aes(y=reclassified_vus,x=bar,fill=Type)) + geom_bar(stat="identity",position = "identity",width = 0.1) +
  scale_fill_manual(values = c("none"="#ccff33", "conserved AA"="#ffff00", "full conserved AA"="#ffcc00", "conserved AA +\nconserved variants"="#ff6600", "full conserved AA +\nconserved variants"="#ff0000")) +
