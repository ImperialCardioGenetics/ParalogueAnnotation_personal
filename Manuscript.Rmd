...
aligned_clinvar_and_benign_protein_pos = intersect(clinvar_B_LB_tableized_protein_pos, patho_protein_pos)
aligned_clinvar_and_benign_COL3A1_variants = data.frame(
  name = "aligned_clinvar_and_benign_protein_variants",
  source = "Jalview",
  type = "aligned_clinvar_and_benign_protein_variants",
  start = aligned_clinvar_and_benign_protein_pos,
  end = aligned_clinvar_and_benign_protein_pos,
  score = 0.0,
  strand = ".",
  phase = "."
) 
write("##gff-version 2","data/all_possible_mutations/COL3A1/aligned_clinvar_and_benign_COL3A1_variants.gff")
write.table(aligned_clinvar_and_benign_COL3A1_variants,"data/all_possible_mutations/COL3A1/aligned_clinvar_and_benign_COL3A1_variants.gff", quote = FALSE, sep = "\t", row.names = FALSE, col.names = FALSE, append = TRUE)
