...
```{r paraz, message=FALSE, cache=TRUE, warning=FALSE, echo=FALSE, fig.width=7,fig.height=6,fig.cap="\\label{fig:paraz}Distribution of genes with paralogues by the number of paralogues they're related to"}
