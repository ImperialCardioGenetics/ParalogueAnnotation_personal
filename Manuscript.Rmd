...
ego = groupGO(gene = eg$ENTREZID, OrgDb = org.Hs.eg.db, keyType = 'ENTREZID', readable = TRUE, ont = "MF", level = 3)
barplot(ego)
...
Variants_remaining_after_PA_QC1 = c(format(conf2$con_table[2], scientific = FALSE),format(conf2$con_table[4], scientific = FALSE),round(conf2$PPV, digits = 3), round(conf2$Sensitivity, digits = 3), round(conf2$Pvalue$p.value, digits = 3))
