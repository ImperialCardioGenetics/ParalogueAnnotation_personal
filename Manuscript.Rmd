...
pander(kable(clinvar_set1))
pander(kable(clinvar_set2))
pander(kable(clinvar_set3))
```
...
<!--Data in below code chunk too big. Unable to KnitR. Have to hard write in numbers in paragraph.-->
