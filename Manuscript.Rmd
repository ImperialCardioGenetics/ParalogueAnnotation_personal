...
gg2_5 = ggplot(prc_data2, aes(x=Sensitivity, y=Precision, colour = Type)) + geom_point(size=2) + xlim(0,0.25) + ylim(0.6,1)  + theme(plot.subtitle = element_text(vjust = 1), 
    plot.caption = element_text(vjust = 1), 
    axis.title = element_text(size = 16), 
...
gg3 = ggplot(benign_data, aes(x=Sensitivity, y=Precision, colour = Type)) + geom_point(size=2) + xlim(0,0.25) + ylim(0,1)  + theme(plot.subtitle = element_text(vjust = 1),
                                                                                                                                  plot.caption = element_text(vjust = 1),
                                                                                                                                  axis.title = element_text(size = 16), 
...
gg4 = ggplot(other_tools_data, aes(x=Sensitivity, y=Precision, colour = Type)) + geom_point(size=2) + xlim(0,1) + ylim(0.8,1)  + theme(plot.subtitle = element_text(vjust = 1),
    plot.caption = element_text(vjust = 1), 
    axis.title = element_text(size = 16), 
    plot.title = element_text(size = 14)) +labs(title = "Precision-Sensitivity space plot of Paralogue Annotation", 
