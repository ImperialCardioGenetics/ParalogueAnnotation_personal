...
```{r synthetic_exome, cache=TRUE, echo = FALSE, results='asis', message = FALSE, warning=FALSE}
...
for (i in files){
  ...
  Total_annotations = rbind(Total_annotations, setdiff(p.normal_PA$Unique_variant_annotations, Total_annotations))
