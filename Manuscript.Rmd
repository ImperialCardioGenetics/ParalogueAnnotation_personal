...
gene_EFs = dplyr::bind_rows(gene_EFs,data.frame(gene="Overall",
                                                ...
                                                pastlapply(c(all_rare_vars$OR,all_rare_vars$OR_CI),format,digits=3,nsmall=3))
                                                
                                                
                                                all_rare_vars$EF,
                                                all_rare_vars$EF_CI,
                                                pa_predicted_rare_vars$OR,
                                                pa_predicted_rare_vars$OR_CI,
                                                pa_predicted_rare_vars$EF,
                                                pa_predicted_rare_vars$EF_CI
...
write.table(gene_EFs, file = "data/case_and_control/gene_EFs.csv", na="", row.names = FALSE, col.names = FALSE, sep = ",", quote=FALSE)
