...
Variants_removed_after_PA_QC2 = c(var_removed2$con_table[2],var_removed2$con_table[4],round(digits = 3,var_removed2$PPV),round(digits = 3,var_removed2$Sensitivity),round(digits = 3,var_removed2$Specificity),signif(digits = 3,var_removed2$Pvalue$p.value))
