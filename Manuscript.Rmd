...
protein_classes$stage = "After Paralogue\nAnnotation"
...
protein_classes2$stage = "Only Paralogue\ngenes"
#control - 4340 clinvar genes with only missense
protein_classes3 = read.csv(file="data/clinvar/4340_clinvar_genes_w_only_missense_GO_protein_class.txt", sep = "\t", header = FALSE, stringsAsFactors = FALSE)
...
protein_classes3$stage = "All genes with\nmissense Clinvar variants"
#Total_plot
total_protein_class = rbind(protein_classes, protein_classes2, protein_classes3)
# total_protein_class[total_protein_class$Protein_class=="transmembrane receptor regulatory/adaptor protein (PC00226)", "Protein_class"]

gg_protein_class = ggplot(total_protein_class, aes(y=number_of_genes, x=reorder(Protein_class, number_of_genes), fill = factor(stage, levels=c("After Paralogue\nAnnotation","Only Paralogue\ngenes","All genes with\nmissense Clinvar variants")))) +
