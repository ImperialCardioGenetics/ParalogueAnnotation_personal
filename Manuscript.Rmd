...
rownames(clinvar_set) = c("Total variants", 
                          ...
                          "Variants remaining after QC3 + QC1, no QC2", 
                          "Variants removed from QC1", 
                          "Variants removed from QC2",  
                          "Variants removed from QC3",
                          "Variants removed from QC3 + QC1, no QC2")
...
normal_PA4_conf = conf_matrix(p.normal_PA5$true_num_of_paralog_anno, p.normal_PA2$input_variants, b.normal_PA5$true_num_of_paralog_anno, b.normal_PA2$input_variants)
