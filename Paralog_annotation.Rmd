...
* Debugging plugin
    ...
    + Before sending Emily email:
        - move variant 14 23425730 down a few places and see if still consistently throwing SQL error
        
    + Following chat with Erica, before emailling Emily with what was discussed.
