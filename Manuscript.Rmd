...
bar_chart = ggplot(Total_clinvar_set, aes(y=Pathogenic_var, x=bar, fill=Stage)) + geom_bar(stat="identity", position="dodge")
  # scale_y_log10() 
...
gg_protein_class = ggplot(total_protein_class, aes(y=number_of_genes, x=reorder(Protein_class, number_of_genes), fill = stage)) +
  ...
  scale_fill_manual(values= c(alpha("red",0.9), alpha("blue",0.4))) + 
  guides(fill = guide_legend(reverse=TRUE)) +
  scale_y_continuous(breaks = c(0,50,100,150,200,250,300,350,400), limits = c(0,200), expand = c(0,0)) +
