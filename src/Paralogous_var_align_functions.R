...
Paralogous_var_align = function(paralogs2_file, paralog_tableized_file, joining_tableized_file=paralog_tableized_file){ #Function for joining together variant paralogous locations
  ...
  max_no_col = (max(count.fields(paralog_data, sep = "\t"))-6) #-6 for "Variant_pos", "ID", "Gene", "Ref", "Alt", and "\n"
  ...
  return(list("paralog_data" = paralog_data, "gathered_paralog_data" = gathered_paralog_data, "Total_paralog_annotations" = Total_paralog_annotations, "num_of_paralog_anno" = num_of_paralog_anno, "ref_data" = ref_data))
}

conf_matrix = function(ptop.num_of_paralog_anno, p.paralog_data, btop.num_of_paralog_anno, b.paralog_data){
  ...
  return(list("con_table" = con_table, "PPV" = con_table_PPV, "Sensitivity" = con_table_Sensitivty, "Pvalue" = con_table_p_value, "TP" = con_table_TP, "FP" = con_table_FP, "TN" = con_table_TN, "FN" = con_table_FN))
}