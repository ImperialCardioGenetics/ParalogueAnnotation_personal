...
#rare = AF < 0.001 #NEED TO FILTER OUT FOR MISSENSE ONLY IN OG VCF
rare_gnomad = read.csv(file=gzfile("data/gnomad_exome_r2.1.1/gnomad.exomes.r2.1.1.sites.AFlessthan0.001andnot0PASS_only_var_info.vcf_split/gnomad.exomes.r2.1.1.sites.AFlessthan0.001andnot0PASS_only_var_info.vcf_split00.gz"), sep = "\t", header=FALSE, col.names = c("CHROM","POS","ID","REF","ALT","QUAL","FILTER","INFO"), stringsAsFactors=FALSE)
rare_gnomad2 = read.csv(file=gzfile("data/gnomad_exome_r2.1.1/gnomad.exomes.r2.1.1.sites.AFlessthan0.001andnot0PASS_only_var_info.vcf_split/gnomad.exomes.r2.1.1.sites.AFlessthan0.001andnot0PASS_only_var_info.vcf_split01.gz"), sep = "\t", header=FALSE, col.names = c("CHROM","POS","ID","REF","ALT","QUAL","FILTER","INFO"), stringsAsFactors=FALSE)
rare_gnomad3 = read.csv(file=gzfile("data/gnomad_exome_r2.1.1/gnomad.exomes.r2.1.1.sites.AFlessthan0.001andnot0PASS_only_var_info.vcf_split/gnomad.exomes.r2.1.1.sites.AFlessthan0.001andnot0PASS_only_var_info.vcf_split02.gz"), sep = "\t", header=FALSE, col.names = c("CHROM","POS","ID","REF","ALT","QUAL","FILTER","INFO"), stringsAsFactors=FALSE)
rare_gnomad = rbind(rare_gnomad,rare_gnomad2,rare_gnomad3)
rm(rare_gnomad2, rare_gnomad3)
