...
rare_gnomad = read.csv(file=gzfile("data/gnomad_exome_r2.1.1/gnomad.exomes.r2.1.1.sites.AFlessthan0.001PASSFilter_only_var_info.vcf.gz"), sep = "\t", header=TRUE, stringsAsFactors=FALSE)
