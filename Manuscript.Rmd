...
write.table(gene_EFs, file = "data/BrS/Ackerman_LQTS_EFs.csv", na="", row.names = FALSE, col.names = FALSE, sep = ",", quote=FALSE)
...
names(CALM_variants)[1] = "#CHROM"
CALM_variants = CALM_variants[c("#CHROM","position","ID","reference","alternate","QUAL","FILTER","INFO")]
