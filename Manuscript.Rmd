...
#KCNE1_control_all_variant_cases = KCNE1_control_all_variant_cases$Allele.Number
...
control_cohort_data = control_data_ref[control_data_ref$rsID %in% control.paralogous_var_align$Unique_variant_annotations$ID.x,] #had to manually edit in custom IDs that were auto added during python vcf conversion

###rare variant EFs

gene_EFs = data.frame()
for (gene in c("KCNE1","KCNE2","KCNH2","KCNQ1","SCN5A")){
